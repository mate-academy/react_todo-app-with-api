...
> Here is [the working example](https://mate-academy.github.io/react_todo-a title is empty delete the todo the same way the `x` button does it;

- if the title was changed show the loader while waiting for the API response;pp-with-api/)
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://BadOfficer.github.io/react_todo-app-with-api/) and add it to the PR description.
