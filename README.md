...
Implement a simple Todo App saving all the changes to [the API](https://mate-academy.github.io/fe-students-api/).
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://OlgaStakhova.github.io/react_todo-app-with-api/) and add it to the PR description.
