...
- Replace `OlgaOchichenko` with your Github username in the [DEMO LINK](https://OlgaOchichenko.github.io/react_todo-app-with-api/) and add it to the PR description.
