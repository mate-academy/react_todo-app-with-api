...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://svyatoslav1313.github.io/react_todo-app-with-api/) and add it to the PR description.
