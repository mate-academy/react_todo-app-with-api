...
Take your code implemented for [Add and Delete](https://andriy-stetsula.github.io/react_todo-app-add-and-delete/)
and implement the ability to toggle and rename todos.

> Here is [the working example](https://andriy-stetsula.github.io/react_todo-app-with-api/)
