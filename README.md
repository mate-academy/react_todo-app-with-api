...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://danil-hodytskyi.github.io/react_todo-app-with-api/) and add it to the PR description.
