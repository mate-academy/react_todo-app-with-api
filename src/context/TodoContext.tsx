...
export type FilterAction = Filter.All | Filter.Active | Filter.Completed;
...
type TodoContextType = {
  ...
  filteredBy: Filter;
  setFilteredBy: (type: Filter) => void;
  error: string | null;
...
export const TodoProvider: React.FC<Props> = ({ children }) => {
  ...
  const [filteredBy, setFilteredBy] = useState<Filter>(Filter.All);
